function [auxall,pop,objvs,clustTag,clustName,centroid]=GeOACES_hv_a(auxPop,auxObjvs,pop,objvs,clustTag,clustName,selectedSize,objDim,varDim,Kmax,auxVals,Population)
