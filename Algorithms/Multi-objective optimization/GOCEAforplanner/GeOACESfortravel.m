function [auxall,pop,objvs,clustTag,clustName,centroid]=GeOACESfortravel(auxPop,auxObjvs,pop,objvs,clustTag,clustName,selectedSize,objDim,varDim,Kmax,auxVals,Population,Problem)
