function [currentSol,validPoints,bj]=checknode_singlepath_close_newbj(currentSol,varDim,buildings,numBuildings,cylinders,numCylinders,spheres,numSpheres,pyramids,numPyramids,jinfei,numjinfei,dot1,dot2)
%读取cubes数据
 % 文件名
