function [auxa,auxb,auxc,auxall,pop,objvs,clustTag,clustName,centroid]=GeOACESfortravel_singlepath_5_FANGZHEN(auxPop,pop,clustTag,clustName,selectedSize,objDim,varDim,Kmax,Problem,buildings,numBuildings,cylinders,numCylinders,spheres,numSpheres,pyramids,numPyramids,jinfei,numjinfei,dot1,dot2)
...
for i = 1:size(popinitial,1)           
    [popinitial(i,:),validPoints,bj]=checknode_singlepath_close_newbj_FANGZHEN(popinitial(i,:),varDim,buildings,numBuildings,cylinders,numCylinders,spheres,numSpheres,pyramids,numPyramids,jinfei,numjinfei,dot1,dot2);%对当前解包含的航迹点进行碰撞检测
