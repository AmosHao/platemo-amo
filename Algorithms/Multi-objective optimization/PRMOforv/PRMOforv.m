       ...
       cylinders = load('cylinders.mat').cylinders;
        ...
        numjinfei = size(jinfei, 1);
           ...
           if gen==1
               ...
               [auxa,auxb,auxc,auxall,pop,objVals,clustTag,clustName,centroid]=GeOACESfortravel_singlepath_5(auxPop,pop,clustTag,clustName,selectedSize,objDim,varDim,Kmax,Problem,buildings,numBuildings,cylinders,numCylinders,spheres,numSpheres,pyramids,numPyramids,jinfei,numjinfei,dot1,dot2,gen);
               Population=auxall;
               popSize=size(pop,1);
