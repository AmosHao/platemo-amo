 ...
 methods
        ...
        if size(PopDec,1)>1
             for i = 1:size(PopDec,1) 
                ...
                if PopObj(i,1)<0.05
                    PopObj(i,2)= (1+g(i,1))*(1-19*PopDec(i,1));
                else
                    PopObj(i,2)= (1+g(i,1))*(1/19-PopDec(i,1)/19);
                end
             end
            ...
            if PopObj(1,1)<0.05
                    PopObj(1,2)= (1+g(1,1))*(1-19*PopDec(1,1));
                else
                    PopObj(1,2)= (1+g(1,1))*(1/19-PopDec(1,1)/19);
            end
