 ...
 methods
        ...
        if size(PopDec,1)>1
             for i = 1:size(PopDec,1)
                g(i,1) = sum((PopDec(i,3:D)-sin(2*pi*PopDec(i,1)+(3:D)*pi/D)).^2);
            ...
            PopObj(1,3)= (1+g(1,1))*(1-sin(PopDec(1,1)*pi/2));
