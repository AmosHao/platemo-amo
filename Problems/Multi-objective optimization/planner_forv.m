...
% <multi/many> <real> <large/none> <expensive/none>
 methods
        ...
        function Setting(obj)
            ...
            if isempty(obj.D); obj.D =n_dots*4; end
            vmax=30;
            % D=obj.D;
            ...
            obj.lower(3*n_dots+1:4*n_dots) = 0*ones(1,n_dots);
            obj.upper(3*n_dots+1:4*n_dots) = vmax*ones(1,n_dots);
        ...
        PopObj(j,1)=sum(time);   % 计算全部航迹的长度，即优化目标1
