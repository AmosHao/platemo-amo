classdef planner_travel_checkrestrain < PROBLEM
% <multi/many> <real> <large/none> <expensive/none>
 methods
   ...
   % b=[b;1];
   % end
   Penalty7=size(validPoints,1)-sum(validPoints);

Penalty4=5000*Penalty4;
Penalty5=5000*Penalty5;
Penalty7=10000*Penalty7;
...
PopObj(j,1)=PopObj(j,1)/1000;
        PopObj(j,1)=PopObj(j,1)+(Penalty1+Penalty2+Penalty3+Penalty4+Penalty5+Penalty6+Penalty7);
        PopObj(j,2)=PopObj(j,2)+(Penalty1+Penalty2+Penalty3+Penalty4+Penalty5+Penalty6+Penalty7);
        PopObj(j,3)=PopObj(j,3)+(Penalty1+Penalty2+Penalty3+Penalty4+Penalty5+Penalty6+Penalty7);        end
        end
