...
%--------------------------------------------------------------------------
    ...
    properties
        ...
        add_clustName;        % Additional properties of the solution
        add_clustTag;        % Additional properties of the solution
        validtrait;        % Additional properties of the solution
        bj;        % Additional properties of the solution
    end
    methods
