function [validPoints]=checknode_singlepath_close(currentSol,varDim,buildings,numBuildings,cylinders,numCylinders,spheres,numSpheres,pyramids,numPyramids,jinfei,numjinfei)
%读取cubes数据
 % 文件名
