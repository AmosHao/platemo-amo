...
function [Obj,igd,hv,igd_end,hv_end]=GOCEArunplatemo(problem,algorithm,Kmax,BETA,F,CR,N,M,D,maxFE,s)
platemo('problem',problem,'algorithm',{algorithm,Kmax,BETA,F,CR},'N',N,'M',M,'D',D,'maxFE',maxFE,'save',s);
