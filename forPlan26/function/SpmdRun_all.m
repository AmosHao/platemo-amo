function SpmdRun_all(problem,algorithm,N,maxFE,s,runTimes,workerNum,vardim,M)
...
spmd
    ...
    % p.runplatemo.Objgens = cell(runTimes, 1);
    % p.runplatemo.Popgens = cell(runTimes, 1);
    ...
    for j=1:runTimes
       ...
       [clustName,clustTag,clustName_end,clustTag_end,Dec,Obj,Dec_end,Obj_end,igd,hv,igd_end,hv_end]=runplatemo_all(problem,algorithm,N,maxFE,s,vardim,M);
...
save(['/media/haichao/9c7b702c-d542-4ac0-8f33-8aac10340a9e/haichao/Desktop/wanghaoyue1/DATAforSHENGAO/planner3/1/', ['_problem',probleminfo,'_algorithm',algorithminfo,'_N',N,'_D',vardim,'_maxFE',maxFE,'_runT',runT,'.mat']],'prob');
save(['/media/haichao/9c7b702c-d542-4ac0-8f33-8aac10340a9e/haichao/Desktop/wanghaoyue1/DATAforSHENGAO/planner3/2/', ['_problem',probleminfo,'_algorithm',algorithminfo,'_N',N,'_D',vardim,'_maxFE',maxFE,'_runT',runT,'.mat']],'qrob');
save(['/media/haichao/9c7b702c-d542-4ac0-8f33-8aac10340a9e/haichao/Desktop/wanghaoyue1/DATAforSHENGAO/planner3/3/', ['_problem',probleminfo,'_algorithm',algorithminfo,'_N',N,'_D',vardim,'_maxFE',maxFE,'_runT',runT,'.mat']],'wrob');
