function SpmdRun_all_TRAVEL_PRMO(problem,algorithm,N,maxFE,s,runTimes,workerNum,M,dots)
...
spmd
    ...
    for j=1:runTimes
       ...
       [validtrait_end,validtrait,Dec,Obj,Dec_end,Obj_end,hv,hv_end,pd,pd_end]=runplatemo_all_singlepath_PRMO(problem,algorithm,N,maxFE,s,M,dots);
       % [Dec,Obj,Dec_end,Obj_end,hv,hv_end,pd,pd_end]=runplatemo_all_singlepath_PRMO(problem,algorithm,N,maxFE,s,M,dots);
        ...
        p.runplatemo.ipd_end(j,1)={pd_end};
...
for i=2:workerNum
    ...
    fun.runplatemo.ipd=[fun.runplatemo.ipd;tmpFun.runplatemo.ipd];
    ...
    fun.runplatemo.ipd_end=[fun.runplatemo.ipd_end;tmpFun.runplatemo.ipd_end];
    fun.runplatemo.ihv_end=[fun.runplatemo.ihv_end;tmpFun.runplatemo.ihv_end];
     ...
     qun.Obj_end=[qun.Obj_end;tmpQun.Obj_end];
...
save(['/media/haichao/9c7b702c-d542-4ac0-8f33-8aac10340a9e/haichao/Desktop/wanghaoyue1/PRMOcomparelineall/1/', ['_algorithm',algorithminfo,'.mat']],'prob');
save(['/media/haichao/9c7b702c-d542-4ac0-8f33-8aac10340a9e/haichao/Desktop/wanghaoyue1/PRMOcomparelineall/2/', ['_algorithm',algorithminfo,'.mat']],'qrob');
